<template>
  <div class="mx-auto px-0 md:px-4 py-8 bg-white dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300 ease-in-out">
    ...
    <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <p class="text-center text-gray-600 dark:text-gray-300 mb-6">
        Hash functions ensure data integrity and security by converting any input into a fixed-length string. They're a fundamental part of modern cryptographic systems.
      </p>
      <Apply />
    </section>
  </div>
